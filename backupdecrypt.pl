...
######### $ sudo apt-get install libcrypt-cbc-perl libcrypt-des-ede3-perl libcrypt-des-perl libcrypt-ecb-perl libcrypt-twofish-perl php-crypt-cbc
...
sub get_decryption_keys
{
	...
	my $userkey = "fake";  die "encrypted"; ##Crypt::OpenSSL::PBKDF2::derive(
	...
	my $checksum  = "fake"; die "encrypted";  ## Crypt::OpenSSL::PBKDF2::derive(
